export const perguntas = [
    {
        enunciado: "Assim que você acorda, recebe uma ligação para um trabalho arriscado: roubar um chip de Don Dalpd0z, um ciborgue rico e perigoso. Ao chegar ao local, você avista ele. Qual sua primeira escolha?",
        alternativas: [
            {
