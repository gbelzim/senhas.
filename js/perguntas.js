export const perguntas = [
    {
        enunciado: "Assim que voce acorda, recebe uma ligação para um trabalho arriscado, roubar um chip do Don dalpd0z um ciborgue rico, ao chegar no local do roubo voce avista ele. Qual sua primeira escolha?",
        alternativas: [
            {
